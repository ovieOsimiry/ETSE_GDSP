...
Peripheral Summary:
  ...
  XPS project / EDK repository               : C:\FPGA\Internship_Jobs\Codes\Virtex6_MUL_IP_CORE2
  logical library name                       : matrix_mul_ip_core_s_int_g_v1_00_a
  top name                                   : matrix_mul_ip_core_s_int_g
  version                                    : 1.00.a
...
- HDL source file(s)
  ...
  hdl/vhdl/matrix_mul_ip_core_s_int_g.vhd
...
- XPS interface file(s)
  ...
  data/matrix_mul_ip_core_s_int_g_v2_1_0.mpd
  ...
  data/matrix_mul_ip_core_s_int_g_v2_1_0.pao
...
- ISE project file(s)
  ...
  devl/projnav/matrix_mul_ip_core_s_int_g.xise
  ...
  devl/projnav/matrix_mul_ip_core_s_int_g.tcl

    This is the TCL command line file used to generate the .xise file.

- XST synthesis file(s)

  devl/synthesis/matrix_mul_ip_core_s_int_g_xst.scr
  ...
  devl/synthesis/matrix_mul_ip_core_s_int_g_xst.prj
...
- Driver source file(s)
  ...
  src/matrix_mul_ip_core_s_int_g.h
...
-user needs to add these to repositories path in SDK (Xilinx Tools-->Repositories)
  ...
  data/matrix_mul_ip_core_s_int_g_v2_1_0.mdd

    This is the Microprocessor Driver Definition file.

  data/matrix_mul_ip_core_s_int_g_v2_1_0.tcl
...
axi_lite_ipif_v1_01_a
	C:\FPGA\Internship_Jobs\Codes\Virtex6_MUL_IP_CORE2\C:\Xilinx\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_lite_ipif_v1_01_a\doc\axi_lite_ipif_ds765.pdf

axi_master_lite_v1_00_a
	C:\FPGA\Internship_Jobs\Codes\Virtex6_MUL_IP_CORE2\C:\Xilinx\14.7\ISE_DS\EDK\hw\XilinxProcessorIPLib\pcores\axi_master_lite_v1_00_a\doc\ds836_axi_master_lite.pdf
