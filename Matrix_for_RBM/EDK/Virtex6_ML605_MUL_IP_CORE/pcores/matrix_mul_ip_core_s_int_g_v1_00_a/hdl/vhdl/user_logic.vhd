...
-- Date:              Wed Aug 05 15:25:31 2015 (by Create and Import Peripheral Wizard)
...
architecture IMP of user_logic is
  ...
  ----------------------------------Register slv_reg0 Map------------------------
	 				--INPUTS--			
	--  DIN = slv_reg0(17 downto 0)
	--  RST = slv_reg0(18)
	--  LOAD_PG = slv_reg0(20 downto 19)
	--  UNLOAD = slv_reg0(21)
	--  P = slv_reg0(22)	  
  	--	G = slv_reg0(23)
  	--	Bank_sel_in = slv_reg0(24)
  	
  					--OUTPUTS--
	--	DOUT = slv_reg1(17 downto 0)
	--	READY = slv_reg1(18)
	--	OP_DONE = slv_reg1(19)
	--	LOADING_DONE = slv_reg1(20)
	--	UN_LOADING_DONE = slv_reg1(21)
  
	alias	DIN			: 	std_logic_vector(17 downto 0) 	is	slv_reg0(17 downto 0);
	alias	ip_fsm_rst 	: 	std_logic 						is	slv_reg0(18);
	alias	LOAD_PG		:	std_logic_vector(1 downto 0) 	is	slv_reg0(20 downto 19);
	alias	UN_LOAD		:	std_logic						is	slv_reg0(21);
	alias	P			:	std_logic						is	slv_reg0(22);
	alias	G			:	std_logic						is	slv_reg0(23);
	alias	Bank_sel_in	:	std_logic						is	slv_reg0(24);
...
generic map(
  ...
  begin
    ...
    if Bus2IP_Clk'event and Bus2IP_Clk = '1' then
		...
		slv_reg1(17 downto 0) <= s_DOUT;
		slv_reg1 <= (
			18 => s_READY, 
			19 => s_OP_DONE, 
			20 => s_LOADING_DONE, 
			21 => s_UN_LOADING_DONE,
			17 => s_DOUT(17),
			16 => s_DOUT(16),
			15 => s_DOUT(15),
			14 => s_DOUT(14),
...
--            end loop;
  ...
  -- 
  ------------------------------------------
  mst_reg_write_req <= Bus2IP_WrCE(2) or Bus2IP_WrCE(3) or Bus2IP_WrCE(4) or Bus2IP_WrCE(5);
  mst_reg_read_req  <= Bus2IP_RdCE(2) or Bus2IP_RdCE(3) or Bus2IP_RdCE(4) or Bus2IP_RdCE(5);
  mst_reg_write_sel <= Bus2IP_WrCE(5 downto 2);
  mst_reg_read_sel  <= Bus2IP_RdCE(5 downto 2);
